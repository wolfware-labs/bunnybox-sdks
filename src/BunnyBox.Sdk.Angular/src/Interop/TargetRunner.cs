...
using BunnyBox.Sdk.NodeJs.Abstractions;
using BunnyBox.Sdk.NodeJs.Models;
...
internal sealed class TargetRunner : ITargetRunner
{
  ...
  public TargetRunner(IModuleRunner moduleRunner)
  {
    ...
    var scriptContentStream =
      assembly.GetManifestResourceStream($"BunnyBox.Sdk.Angular.src.Interop.Scripts.{TargetRunner.ScriptName}");
