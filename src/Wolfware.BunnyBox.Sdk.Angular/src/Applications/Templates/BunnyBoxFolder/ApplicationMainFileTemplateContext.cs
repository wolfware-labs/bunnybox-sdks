...
using Wolfware.BunnyBox.Sdk.Projects.Exceptions;
using Wolfware.BunnyBox.Sdk.Angular.Utils;
...
internal sealed class ApplicationMainFileTemplateContext
{
  ...
  public static ApplicationMainFileTemplateContext FromProject(global::Wolfware.BunnyBox.Sdk.Projects.Project project)
  {
  ...
  private static RouteDetails[] GetRoutes(global::Wolfware.BunnyBox.Sdk.Projects.Project project)
  {
